...
public class CommunityController {
    ...
    public String SavePost(@AuthenticationPrincipal Jwt jwt, PostDto postDto) {
        ...
        postService.savePost(new Post(null, nickname, postDto.category(), postDto.industryTag(), postDto.title(),
                postDto.content(), simpleDateFormat.format(nowDate), 0, 0, Role.USER));
    ...
    public String GetEditPost(Model model, @RequestParam Long id, @AuthenticationPrincipal Jwt jwt) {
        ...
        model.addAttribute("postDto",
                new PostDto(post.getCategory(), post.getIndustryTag(), post.getTitle(), post.getContent()));
    ...
    public String SaveComment(@AuthenticationPrincipal Jwt jwt, CommentDto commentDto) {
        ...
        commentService.saveComment(new Comment(null, postService.findByPostId(commentDto.postid()), nickname,
                commentDto.content(), simpleDateFormat.format(nowDate)));
